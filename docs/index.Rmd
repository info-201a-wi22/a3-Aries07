...
This chart shows the number of Jail population for each race from 2008 to 2018. I used this chart to display in each year, the jail population varied from race to race. It indicates that no matter for which year the **latinx race** jail population were higher than other race. Additionally, aside from the other race jail population, **white race** jail population always lower than other races.
...
This chart displays the relationship between total population and total jail population in each state. It is obvious that when the total population increase the total jail population will increase as well.
...
## Map
This map shows that states with more total jail administration concentrated in the south-eastern part of United State.
